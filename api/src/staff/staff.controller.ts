...
export class StaffController {
  ...
  @ApiResponse({ status: 409, description: 'El nombre de usuario o correo electrónico ya están en uso' })
  ...
  @ApiResponse({ status: 200, description: 'Personal encontrado', type: [Staff] })
