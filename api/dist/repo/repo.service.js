...
let RepoService = class RepoService {
    ...
    async createRepo(nombreProyecto, descripcion, fechaInicio, fechaFinalizacion) {
        const repo = this.repoRepository.create({ nombreProyecto, descripcion, fechaInicio, fechaFinalizacion });
